    ...
    private void initFirebase() {
        try {
            ...
            FirebaseOptions firebaseOptions = new FirebaseOptions.Builder()
                    .setDatabaseUrl("https://comidas-de2cf-default-rtdb.firebaseio.com/") // 
                    // .setDatabaseUrl("https://zoolaspalmas-default-rtdb.firebaseio.com/")
                    .setServiceAccount(new FileInputStream(new File("C:\\Users\\ESTUDIANTE\\Documents\\parcial2Database")))
