...
import parcial2.Pedido;

/**
 *
 * @author ESTUDIANTE
 */
public class GestionComidas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        textDocumento.setText("jTextField2");
        ...
        listaComida.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Manzana", "Pera", "Banano", "Fresa", "Mandarina", "Naranja", "Papaya", "Borojo", "Limon", "Aguacate", "Ahuyama", "Habichuela", "Zanahoria", "Calabaza", "Remolacha", "Espinaca", "Arveja", " ", " ", " " }));
        listaComida.setToolTipText("");
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        indice = listaComida.getSelectedIndex();
        opcion = listaComida.getItemAt(indice);
        
        //--------------------------------------

        Cliente cliente = new Cliente(nom,doc);
        Pedido pedido = new Pedido(cliente);
        
        pedido.alimentos(opcion);
        System.out.println("El alimento escogido por "+ nom + " es ");
